...
namespace SurveyBasket.ApI.Migrations
{
    ...
    [Migration("20240721092339_addVoteAndVoteAnswerEntity")]
    partial class addVoteAndVoteAnswerEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SurveyBasket.ApI.Entities.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SurveyBasket.ApI.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SurveyBasket.ApI.Entities.Question", b =>
                {
                    b.HasOne("SurveyBasket.ApI.Entities.AppUser", "CreatedBy")
                        .WithMany()
                    ...
                    b.HasOne("SurveyBasket.ApI.Entities.AppUser", "UpdatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("SurveyBasket.ApI.Entities.Vote", b =>
                {
                    ...
                    b.HasOne("SurveyBasket.ApI.Entities.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
